...
export const metadata: Metadata = {
  title: "surfthecompany",
  description: "Surf the web. Know the company. Instantly get detailed research insights and know everything about any company inside out.",
  openGraph: {
    title: 'surfthecompany',
    description: 'Surf the web. Know the company. Instantly get detailed research insights and know everything about any company inside out.',
